#@copyright Ophir LOJKIN
# copied from https://github.com/kripken/sql.js/ at modified to initialize spatialite
...
class Database
  ...
  **Warning**: A statement belonging to a database that has been closed cannot
  ...
  @param data [Object]
  ###
  'loadshp': (tablename, codeset, srid, data) ->
    ...
    load_shapefile_ex @db, filename, tablename, codeset, srid, 0, 0, 0, 0, 0, 0, 0, 0, 0
