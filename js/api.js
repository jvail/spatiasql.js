...
Database = (function() {
  function Database(data) {
    ...
    this.statements = {};
    this.cache = spatialite_alloc_connection();
    spatialite_init_ex(this.db, this.cache, 1);
  }
